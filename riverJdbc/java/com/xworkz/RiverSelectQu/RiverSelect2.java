...
public class RiverSelect2 {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		Connection con = null;
		try {
		 con = DriverManager.getConnection(DBConst.username, DBConst.username, DBConst.password);
		Statement state = con.createStatement();
		String sql = "select * from  river WHERE R_name='cauvery' and R_Origin='kodagu'";
